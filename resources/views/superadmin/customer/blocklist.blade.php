        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Block list</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title"><a href="{{ url()->previous() }}"><i class="fa fa-arrow-left"
                            aria-hidden="true"></i></a> &nbsp; Block List</h2>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($allview as $alllists)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($alllists->cust_status == 2)
                                                        <a href="#" onclick="confirmApprovalblock('{{ route('admin.custblockappro', $alllists->id) }}')" class="badge badge-danger">Approval</a>
                                                    @endif
