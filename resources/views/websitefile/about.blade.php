            ...
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center">
                    ...
                    <div class="col-md-7 col-sm-12 text-center ftco-animate">
                        ...
                        <p class="breadcrumbs"><span class="mr-2"><a href="{{ url('/') }}">Home</a></span> <span>About</span>
                        </p>
                    </div>
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div class="one-half ftco-animate">
            <div class="overlap">
                ...
                <div>
                    <p class="text-white">On her way she met a copy. The copy warned the Little Blind Text, that where it
