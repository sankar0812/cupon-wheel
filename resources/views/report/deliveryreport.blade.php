    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Delivery Report</div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.deliveryreport', ['detail' =>"month"]) }}" method="get">
                                <!-- @csrf -->
                        ...
                        <div class="card-body">
                            ...
                            <div id="deliveryReport">
                                <table id="subscribersTable" class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach($deliveriesByDeliveryBoy as $delivery)
                                        <tr>
                                            <td>{{ $delivery->name }}</td>
