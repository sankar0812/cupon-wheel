    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Order View </div>
            </div>
        </div>
    </section>
    <div class="container">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col mobile-col" style="font-weight: bold;">Session</div>                                   
                                    <!-- <div class="col mobile-col" style="font-weight: bold;">Status</div> -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="text-right">
                                    @if($order->ord_deliverystatus != 'DELIVERED')
                                    <button class="btn btn-warning" data-toggle="modal" data-target="#assumeorder">Delivery</button>
                                    @else
                                    @endif
